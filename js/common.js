 ...
 /* 验证码倒计时*/
	...
	$('#userName').blur(function(){
		if($(this).val()==""){
		   ...
		   $(this).next().show().html('请支持中文、字母、数字,4-32位');
		   $(this).next().show().css('color','red');
		   return false;
		}
	})
...
$(".header li").click(function () {
    ...
    if(text=="商品管理"){
        window.location.href="../demo/sale-goods.html"
    }
    if(text=="订单管理") {
...
$(".left ul ul li").click(function () {
    ...
    if(text=="待售商品"){
        window.location.href="../demo/forSale.html"
    }
    if(text=="草稿箱"){
